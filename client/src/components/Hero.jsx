      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 pt-12 lg:pt-12 pb-10 grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <p className="text-xl text-slate-600 mb-10 max-w-lg leading-relaxed font-medium">
            The all-in-one marketplace to find, book, and review the best local service providers in your neighborhood.
          </p>
          ...
          <div className="relative group max-w-xl">
            ...
            <div className="relative flex flex-col md:flex-row gap-2 p-2 bg-white rounded-[2rem] shadow-xl border border-slate-100">
              ...
              <button className="px-10 py-4 bg-indigo-600 hover:bg-slate-900 text-white rounded-[1.5rem] font-bold transition-all flex items-center justify-center gap-2 group">
                Find Help 
          ...
          <div className="mt-10 flex items-center gap-8 border-t border-slate-200 pt-8">
            <div>
              ...
              <div className="text-sm font-semibold text-slate-500">Verified Pros</div>
            </div>
            <div className="w-px h-10 bg-slate-200"></div>
            <div>
              <div className="text-2xl font-bold text-slate-900">4.9/5</div>
              <div className="text-sm font-semibold text-slate-500">User Rating</div>
            </div>
          </div>
        </motion.div>
        ...
        <div className="relative">
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-slate-900/90 to-transparent text-white">
              ...
              <p className="text-slate-300 font-medium">Master Electrician • 12 years exp.</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              <div className="text-xs font-black text-slate-400 uppercase tracking-tighter">Safety First</div>
              <div className="text-sm font-bold text-slate-800">Fully Insured</div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              <div className="text-xs font-black text-slate-400 uppercase tracking-tighter">Nearby</div>
              <div className="text-sm font-bold text-slate-800">Top Pros in NY</div>
            </div>
          </motion.div>
        </div>
      </main>
