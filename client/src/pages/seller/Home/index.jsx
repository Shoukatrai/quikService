...
const SellerHome = () => {
  ...
  profilePicture: "https://images.unsplash.com/photo-1540569014015-19a7be504e3a?w=400&h=400&fit=crop",
  ...
  hourlyRate: 45,
  serviceRadius: 25,
  skills: ["Pipe Repair", "Gas Leak Detection", "Water Heater Installation", "Drain Cleaning", "Emergency Services"],
  ...
  return <SellerDashboardLayout user={userData}>
